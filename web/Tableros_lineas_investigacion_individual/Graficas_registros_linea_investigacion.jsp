<%-- 
    Document   : Graficas_linea_registros
    Created on : 18 may. 2020, 12:49:38
    Author     : laloa
--%>
...
<!--Fin de titulo horizontal-->  
	...
	<div class="content" style="z-index: 2; height: 110vh; min-width: 650px;">
        <h3 class="text-muted"><i class="fas fa-file-import"></i> Graficas de registros</h3>
       ...
       <option value="Linea">Linea</option>
        ...
        <div class="form-inline my-2">
          <p class="text-muted"><%=(String)request.getAttribute("linea")%>, total de asignaciones <%=(Integer)request.getAttribute("conteoTotal")%></p>
        </div>
