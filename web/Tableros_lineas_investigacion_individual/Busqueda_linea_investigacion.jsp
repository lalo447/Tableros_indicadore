<%-- 
    Document   : Busqueda_linea
    Created on : 17 may. 2020, 9:28:20
    Author     : laloa
--%>
...
<!--Fin de titulo horizontal-->  
	...
	<div class="content" style="z-index: 2; height: 100vh; min-width: 650px;">
        ...
        <h2 class="text-muted"><i class="fas fa-file-import"></i> Busqueda de linea</h2>
        ...
        String coor_linea[]=null;
        String clave_departamento[]=null;
        ...
        coor_linea=(String [])request.getAttribute("coor_linea");
        clave_departamento=(String [])request.getAttribute("clave_departamento");
        conteoReg=clave_linea.length;
        }
        ...
        nombre_linea=null;
        coor_linea=null;
        clave_departamento=null;
         stConteo=con.createStatement();
         rsConteo=stConteo.executeQuery("select count(*) from linea_investigacion where nombre_linea='"+campoBusqueda+"' or clave_linea='"+campoBusqueda+"' order by nombre_linea");
         st=con.createStatement();
         rs=st.executeQuery("select clave_linea, nombre_linea, coor_linea, clave_departamento_fk from linea_investigacion where nombre_linea='"+campoBusqueda+"' or clave_linea='"+campoBusqueda+"' order by nombre_linea");             
        ...
        coor_linea=new String[conteoReg];
        clave_departamento=new String[conteoReg];
       ...
       <th scope="col" class="text-left">Clave de departamento</th>
      ...
      <td class="text-left"><%=coor_linea[i]%></td>
      <td class="text-left"><%=clave_departamento[i]%></td>
      <td class="text-left"><a href="./Tableros_linea_investigacion?clave=<%=clave_linea[i]%>&nombreC=<%=nombre_linea[i]%>"><button class="btn resumen" style="background:#35D3C3; color:#fff; border: 1px solid #35D3C3;" title="Ver tableros"><i class="fas fa-paste"></i></button></a></td>
      </tr>
      <%}%>
      </tbody>
      </table>
