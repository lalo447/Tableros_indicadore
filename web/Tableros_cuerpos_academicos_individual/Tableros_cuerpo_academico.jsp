<%-- 
    Document   : Tableros_cuerpo_academico
    Created on : 24 may. 2020, 10:53:25
    Author     : laloa
--%>
...
<!--Fin de titulo horizontal-->  
	...
	<div class="content" style="z-index: 2; height: 100vh; min-width: 400px;">
        <h2 class="text-muted"><i class="fas fa-archive"></i> Tableros de cuerpos academicos</h2>
        <hr class="color-secondary">
        
        <div class="table-responsive" style="height: 85%;">
         <p class="text-muted mx-2"><i class="fas fa-archive"></i> <%=nombreC%></p>
        ...
        <p class="card-title text-center" style="font-size: 60px;"><i class="fas fa-users"></i>
        <%=request.getAttribute("countInt")%></p>
        <p class="card-text text-center">Integrantes asigandos</p>
        </div>
        <a href="./Tableros_registros_cuerpo_academico?clave=<%=clave%>&nombreC=<%=nombreC%>" role="button" class="<%=request.getAttribute("bloInt")%> btn text-center text-success card-footer bg-transparent" style="border: 1px solid #02DA5A;">Ver integrantes</a>
        </div></div>
