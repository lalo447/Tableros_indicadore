<%-- 
    Document   : Tableros_derechos_autor_profesor
    Created on : 9 may. 2020, 11:10:42
    Author     : laloa
--%>
...
<!--Fin de titulo horizontal-->  
	...
	<div class="content" style="z-index: 2; height: 100vh; min-width: 650px;">
        ...
        <h2 class="text-muted"><i class="fas fa-chalkboard-teacher"></i> Derechos de autor de profesores</h2>
        ...
        rsNumRegistros=stNumRegistros.executeQuery("select u.nombre, u.apellido_p, u.apellido_m, count(u.rfc) from usuario_profesor u, prof_colbr_dcho pr, patente_dcho_autor p  where u.rfc=pr.rfc and pr.clave_dcho_autor=p.clave_dcho_autor and u.rfc='"+rfcSelect+"' group by u.rfc order by u.nombre");      
        stConteo=con.createStatement();
        rsConteo=stConteo.executeQuery("select count(*) from usuario_profesor u, prof_colbr_dcho pr, patente_dcho_autor p  where u.rfc=pr.rfc and pr.clave_dcho_autor=p.clave_dcho_autor and u.rfc='"+rfcSelect+"' order by u.nombre");      
        st=con.createStatement();
        rs=st.executeQuery("select u.rfc, u.nombre, u.apellido_p, u.apellido_m, p.titulo_proyecto, p.estado_patente, p.numero_tramite, p.fch_registro, p.fch_solicitud from usuario_profesor u, prof_colbr_dcho pr, patente_dcho_autor p  where u.rfc=pr.rfc and pr.clave_dcho_autor=p.clave_dcho_autor and u.rfc='"+rfcSelect+"' order by u.nombre");
        ...
        if(fecha_desde!=null && fecha_hasta!=null){ 
           ...
           stNumRegistros=con.createStatement();
           rsNumRegistros=stNumRegistros.executeQuery("select u.nombre, u.apellido_p, u.apellido_m, count(u.rfc) from usuario_profesor u, prof_colbr_dcho pr, patente_dcho_autor p  where u.rfc=pr.rfc and pr.clave_dcho_autor=p.clave_dcho_autor and fch_solicitud>='"+fecha_desde+"' and fch_solicitud<='"+fecha_hasta+"' and u.rfc='"+rfcSelect+"' group by u.rfc order by u.nombre");      
           stConteo=con.createStatement();
           rsConteo=stConteo.executeQuery("select count(*) from usuario_profesor u, prof_colbr_dcho pr, patente_dcho_autor p  where u.rfc=pr.rfc and pr.clave_dcho_autor=p.clave_dcho_autor and fch_solicitud>='"+fecha_desde+"' and fch_solicitud<='"+fecha_hasta+"' and u.rfc='"+rfcSelect+"' order by u.nombre");      
           st=con.createStatement();
           rs=st.executeQuery("select u.rfc, u.nombre, u.apellido_p, u.apellido_m, p.titulo_proyecto, p.estado_patente, p.numero_tramite, p.fch_registro, p.fch_solicitud from usuario_profesor u, prof_colbr_dcho pr, patente_dcho_autor p  where u.rfc=pr.rfc and pr.clave_dcho_autor=p.clave_dcho_autor and fch_solicitud>='"+fecha_desde+"' and fch_solicitud<='"+fecha_hasta+"' and u.rfc='"+rfcSelect+"' order by u.nombre");
           fechasBusqueda="true";
           }            
           }
