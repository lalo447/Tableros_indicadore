<%-- 
    Document   : Resumen_tableros_profesor
    Created on : 8 may. 2020, 11:58:47
    Author     : laloa
--%>
...
<!--Fin de titulo horizontal-->  
	...
	<div class="content" style="z-index: 2; height: 100vh; min-width: 650px;">
        <h2 class="text-muted"><i class="fas fa-chalkboard-teacher"></i> <%=request.getAttribute("tituloPrin").toString()%></h2>
        <hr class="color-secondary"> 

       <div class="table-responsive" style="height: 70%; min-width: 600px;">
       <h5 class="text-muted"><%=titulo%></h5>
       <p class="text-justify text-muted"><%=request.getAttribute("resumen")%></p>
