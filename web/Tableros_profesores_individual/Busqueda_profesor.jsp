<%-- 
    Document   : Busqueda_profesor
    Created on : 7 may. 2020, 13:48:06
    Author     : laloa
--%>
...
<!--Fin de titulo horizontal-->  
	...
	<div class="content" style="z-index: 2; height: 100vh; min-width: 650px;">
        ...
        <h2 class="text-muted"><i class="fas fa-chalkboard-teacher"></i> Busqueda de profesor</h2>
        ...
        rfc=(String [])request.getAttribute("rfc");    
        ...
        tipo_profesor=(String [])request.getAttribute("tipo_profesor");
        ...
        clave_linea=null;   
         ...
         rsConteo=stConteo.executeQuery("select count(*) from usuario_profesor where nombre='"+campoBusqueda+"' or numero_control='"+campoBusqueda+"' or clave_linea='"+campoBusqueda+"' order by nombre");
         st=con.createStatement();
         rs=st.executeQuery("select rfc, numero_control, nombre, apellido_p, apellido_m, correo, tipo_profesor, clave_linea from usuario_profesor where nombre='"+campoBusqueda+"' or numero_control='"+campoBusqueda+"' or clave_linea='"+campoBusqueda+"' order by nombre");             
        ...
        tipo_profesor=new String[conteoReg];
        ...
        while(rs.next()){
            ...
            nombres[x]=rs.getString(3)+" "+rs.getString(4)+" "+rs.getString(5);
      ...
      <td class="text-left"><%=tipo_profesor[i]%></td>
      <td class="text-left"><%=clave_linea[i]%></td>
      <td class="text-left"><a href="./Tableros_profesor?rfc=<%=rfc[i]%>&nombreC=<%=nombres[i]%>"><button class="btn resumen" style="background:#35D3C3; color:#fff; border: 1px solid #35D3C3;" title="Ver tableros"><i class="fas fa-paste"></i></button></a></td>
      </tr>
      <%}%>
      </tbody>
      </table>
