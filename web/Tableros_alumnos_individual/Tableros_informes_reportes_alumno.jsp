<%-- 
    Document   : Tableros_informes_reportes_alumno
    Created on : 14 may. 2020, 9:47:56
    Author     : laloa
--%>
...
<!--Fin de titulo horizontal-->  
	...
	<div class="content" style="z-index: 2; height: 100vh; min-width: 650px;">
        ...
        <h2 class="text-muted"><i class="fas fa-user-graduate"></i> Informes o reportes de alumnos</h2>
        ...
        rsNumRegistros=stNumRegistros.executeQuery("select u.nombre, u.apellido_p, u.apellido_m, count(u.numero_control) from usuario_alumno u, alm_colbr_infrep pr, informe_reporte p  where u.numero_control=pr.numero_control and pr.clave_infrep=p.clave_infrep and u.numero_control='"+numSelect+"' group by u.numero_control order by u.nombre");      
        stConteo=con.createStatement();
        rsConteo=stConteo.executeQuery("select count(*) from usuario_alumno u, alm_colbr_infrep pr, informe_reporte p  where u.numero_control=pr.numero_control and pr.clave_infrep=p.clave_infrep and u.numero_control='"+numSelect+"' order by u.nombre");      
        st=con.createStatement();
        rs=st.executeQuery("select u.numero_control, u.nombre, u.apellido_p, u.apellido_m, p.titulo_informe, p.serie_documento, p.num_volumen, p.rango_paginas, p.fch_publicado from usuario_alumno u, alm_colbr_infrep pr, informe_reporte p  where u.numero_control=pr.numero_control and pr.clave_infrep=p.clave_infrep and u.numero_control='"+numSelect+"' order by u.nombre");
        ...
        if(fecha_desde!=null && fecha_hasta!=null){ 
           ...
           stNumRegistros=con.createStatement();
           rsNumRegistros=stNumRegistros.executeQuery("select u.nombre, u.apellido_p, u.apellido_m, count(u.numero_control) from usuario_alumno u, alm_colbr_infrep pr, informe_reporte p  where u.numero_control=pr.numero_control and pr.clave_infrep=p.clave_infrep and fch_publicado>='"+fecha_desde+"' and fch_publicado<='"+fecha_hasta+"' and u.numero_control='"+numSelect+"' group by u.numero_control order by u.nombre");      
           stConteo=con.createStatement();
           rsConteo=stConteo.executeQuery("select count(*) from usuario_alumno u, alm_colbr_infrep pr, informe_reporte p  where u.numero_control=pr.numero_control and pr.clave_infrep=p.clave_infrep and fch_publicado>='"+fecha_desde+"' and fch_publicado<='"+fecha_hasta+"' and u.numero_control='"+numSelect+"' order by u.nombre");      
           st=con.createStatement();
           rs=st.executeQuery("select u.numero_control, u.nombre, u.apellido_p, u.apellido_m, p.titulo_informe, p.serie_documento, p.num_volumen, p.rango_paginas, p.fch_publicado from usuario_alumno u, alm_colbr_infrep pr, informe_reporte p  where u.numero_control=pr.numero_control and pr.clave_infrep=p.clave_infrep and fch_publicado>='"+fecha_desde+"' and fch_publicado<='"+fecha_hasta+"' and u.numero_control='"+numSelect+"' order by u.nombre");
           fechasBusqueda="true";
           }            
           }
