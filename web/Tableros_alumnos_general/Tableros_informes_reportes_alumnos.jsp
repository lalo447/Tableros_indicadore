<%-- 
    Document   : Tableros_informes_reportes_alumnos
    Created on : 13 may. 2020, 20:05:18
    Author     : laloa
--%>
...
<!--Fin de titulo horizontal-->  
	...
	<div class="content" style="z-index: 2; height: 100vh; min-width: 650px;">
        ...
        if(fecha_desde!=null && fecha_hasta!=null){ 
           ...
           stConteo=con.createStatement();
           rsConteo=stConteo.executeQuery("select count(*) from usuario_alumno u, alm_colbr_infrep pr, informe_reporte p  where u.numero_control=pr.numero_control and pr.clave_infrep=p.clave_infrep and fch_publicado>='"+fecha_desde+"' and fch_publicado<='"+fecha_hasta+"' order by u.nombre");      
           st=con.createStatement();
