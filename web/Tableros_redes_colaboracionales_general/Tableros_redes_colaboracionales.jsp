<%-- 
    Document   : Tableros_redes_colaboracionales
    Created on : 24 may. 2020, 13:02:49
    Author     : laloa
--%>
...
<!--Fin de titulo horizontal-->  
	...
	<div class="content" style="z-index: 2; height: 100vh; min-width: 400px;">
        <h2 class="text-muted"><i class="fas fa-broadcast-tower"></i> Tableros de redes en colaboracion</h2>
       ...
       <center>
        ...
        <a href="./Tableros_departamentos_redes_colaboracionales" role="button" class="<%=request.getAttribute("bloDep")%> btn text-center text-success card-footer bg-transparent" style="border: 1px solid #02DA5A;">Ver departamentos</a>
        </div></div>
        ...
        <a href="./Tableros_cuerpos_redes_colaboracionales" role="button" class="<%=request.getAttribute("bloCuerpo")%> btn text-center text-danger card-footer bg-transparent" style="border: 1px solid #FE5656;">Ver cuerpos academicos</a>
        </div></div>
