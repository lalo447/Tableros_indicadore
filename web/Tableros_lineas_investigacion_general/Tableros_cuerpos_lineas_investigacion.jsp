<%-- 
    Document   : Tableros_cuerpos_lineas_investigacion
    Created on : 16 may. 2020, 14:17:40
    Author     : laloa
--%>
...
<!--Fin de titulo horizontal-->  
	...
	<div class="content" style="z-index: 2; height: 100vh; min-width: 650px;">
        <h2 class="text-muted"><i class="fas fa-file-import"></i> Lineas de investigacion de cuerpos academicos</h2>
       ...
       /*Realizamos los query de consultas de los cuerpos academicos*/
        ...
        rsNumRegistros=stNumRegistros.executeQuery("select l.nombre_linea, count(u.clave_cuerpo) from cuerpo_academico u, linea_investigacion l  where u.clave_linea=l.clave_linea group by l.nombre_linea order by l.nombre_linea");      
        stConteo=con.createStatement();
        rsConteo=stConteo.executeQuery("select count(*) from cuerpo_academico u, linea_investigacion l where u.clave_linea=l.clave_linea");      
        st=con.createStatement();
        rs=st.executeQuery("select l.nombre_linea, u.nombre_cuerpo, u.jefe_cuerpo, (select nombre_red from red_colaboracion where clave_red=u.clave_red) from linea_investigacion l, cuerpo_academico u where l.clave_linea=u.clave_linea order by l.nombre_linea");
        ...
        <form method="POST" action="./Reportes_cuerpos_lineas_investigacion">
        ...
        <input type="hidden" name="nombre_red<%=i%>" value="<%=nombre_red[i]%>">
        <%}%>
        ...
        <input type="hidden" name="titulo" value="Graficas de cuerpos academicos">
