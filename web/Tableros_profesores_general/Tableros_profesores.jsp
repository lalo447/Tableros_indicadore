<%-- 
    Document   : Tableros_profesores
    Created on : 2 may. 2020, 12:31:13
    Author     : laloa
--%>
...
<!--Fin de titulo horizontal-->  
	...
	<div class="content" style="z-index: 2; height: 100vh; min-width: 400px;">
        <h2 class="text-muted"><i class="fas fa-chalkboard-teacher"></i> Tableros de profesores</h2>
        ...
        <a href="./Tableros_proyectos_profesores" role="button" class="<%=request.getAttribute("bloProy")%> btn text-center text-success card-footer bg-transparent" style="border: 1px solid #02DA5A;">Ver proyectos</a>
        </div></div>
        ...
        <a href="./Tableros_publicaciones_profesores" role="button" class="<%=request.getAttribute("bloPub")%> btn text-center text-danger card-footer bg-transparent" style="border: 1px solid #FE5656;">Ver publicaciones</a>
        </div></div>
        ...
        <a href="./Tableros_informes_profesores" role="button" class="<%=request.getAttribute("bloInfrep")%> btn text-center text-warning card-footer bg-transparent" style="border: 1px solid #FFC143;">Ver informes</a>
        </div></div>
        
        <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12">
        <div class=" card mb-5 mx-3" style="max-width: 18rem; width: 265px; border: 1px solid #3FBAE8;">
        ...
        <a href="./Tableros_software_profesores" role="button" class="<%=request.getAttribute("bloSoft")%> btn text-center text-info card-footer bg-transparent" style="border: 1px solid #3FBAE8;">Ver software</a>
        </div></div>
        
         <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12">
        <div class=" card mb-5 mx-3" style="max-width: 18rem; width: 265px; border:1px solid #A0A6B3;">
        ...
        <a href="./Tableros_patentes_profesores" role="button" class="<%=request.getAttribute("bloPat")%> btn text-center text-secondary card-footer bg-transparent" style="border:1px solid #A0A6B3;">Ver patentes</a>
        </div></div>
        
         <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12">
        <div class=" card mb-5 mx-3" style="max-width: 18rem; width: 265px; border: 1px solid #545454;">
        ...
        <a href="./Tableros_derechos_autor_profesores" role="button" class="<%=request.getAttribute("bloDcho")%> btn text-center text-dark card-footer bg-transparent" style="border: 1px solid #545454;">Ver derechos de autor</a>
        </div></div>
        </div>
