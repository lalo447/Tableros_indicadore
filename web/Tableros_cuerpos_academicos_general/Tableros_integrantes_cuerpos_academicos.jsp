<%-- 
    Document   : Tableros_integrantes_cuerpos_academicos
    Created on : 21 may. 2020, 9:54:10
    Author     : laloa
--%>
...
<!--Fin de titulo horizontal-->  
	...
	<div class="content" style="z-index: 2; height: 100vh; min-width: 650px;">
        <h2 class="text-muted"><i class="fas fa-archive"></i> Cuerpos academicos integrantes</h2>
       ...
       /*Realizamos los query de consultas de los integrantes*/
        ...
        rsConteo=stConteo.executeQuery("select count(id_integrantes) from integrantes i, cuerpo_academico c where i.clave_cuerpo=c.clave_cuerpo");      
        st=con.createStatement();
        rs=st.executeQuery("select c.nombre_cuerpo, u.nombre, u.apellido_p, u.apellido_m, u.correo, u.tipo_profesor, u.clave_linea from cuerpo_academico c, integrantes i, usuario_profesor u where c.clave_cuerpo=i.clave_cuerpo and i.rfc=u.rfc order by c.nombre_cuerpo");
        ...
        <form method="POST" action="./Graficas_de_tableros_cuerpos_academicos">
      ...
      <%for(int i=0; i<conteoReg; i++){%>
      <tr class="<%=opcBorde[i]%>">
      <td class="text-left"><%=CuerpoNombresConEsp[i]%></td>
