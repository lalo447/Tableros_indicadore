<%-- 
    Document   : Tableros_instituciones
    Created on : 26 may. 2020, 10:13:28
    Author     : laloa
--%>
...
<!--Fin de titulo horizontal-->  
	...
	<div class="content" style="z-index: 2; height: 100vh; min-width: 400px;">
       ...
       <center>
        ...
        <a href="./Tableros_departamentos_instituciones" role="button" class="<%=request.getAttribute("bloDep")%> btn text-center text-success card-footer bg-transparent" style="border: 1px solid #02DA5A;">Ver departamentos</a>
        </div></div>
        ...
        <a href="./Tableros_cursos_intituciones" role="button" class="<%=request.getAttribute("bloCursos")%> btn text-center text-danger card-footer bg-transparent" style="border: 1px solid #FE5656;">Ver cursos</a>
        </div></div>
