<%-- 
    Document   : Tableros_institucion
    Created on : 27 may. 2020, 9:28:26
    Author     : laloa
--%>
...
<!--Fin de titulo horizontal-->  
	...
	<div class="content" style="z-index: 2; height: 100vh; min-width: 400px;">
        <h2 class="text-muted"><i class="fas fa-school"></i> Tableros de instituciones</h2>
        <hr class="color-secondary">
        
        <div class="table-responsive" style="height: 85%;">
        <p class="text-muted mx-2"><i class="fas fa-school"></i> <%=nombreC%></p>     
       <center>
        ...
        <a href="./Tableros_registros_institucion?clave=<%=clave%>&nombreC=<%=nombreC%>&registros=departamentos" role="button" class="<%=request.getAttribute("bloDep")%> btn text-center text-success card-footer bg-transparent" style="border: 1px solid #02DA5A;">Ver departamentos</a>
        </div></div>
        ...
        <p class="card-title text-center" style="font-size: 60px;"><i class="fab fa-elementor"></i>
        <%=request.getAttribute("countCursos")%></p>
        <p class="card-text text-center">Cursos asignados</p>
        </div>
        <a href="./Tableros_registros_institucion?clave=<%=clave%>&nombreC=<%=nombreC%>&registros=cursos" role="button" class="<%=request.getAttribute("bloCursos")%> btn text-center text-danger card-footer bg-transparent" style="border: 1px solid #FE5656;">Ver cursos</a>
        </div></div>
