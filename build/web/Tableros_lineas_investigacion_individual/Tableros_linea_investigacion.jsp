<%-- 
    Document   : Tableros_linea_investigacion
    Created on : 24 may. 2020, 10:06:14
    Author     : laloa
--%>
...
<!--Fin de titulo horizontal-->  
	...
	<div class="content" style="z-index: 2; height: 100vh; min-width: 400px;">
        ...
        <p class="text-muted mx-2"><i class="fas fa-file-import"></i> <%=nombreC%></p>
        ...
        <a href="./Tableros_registros_linea_investigacion?clave=<%=clave%>&nombreC=<%=nombreC%>&registros=alumnos" role="button" class="<%=request.getAttribute("bloAlm")%> btn text-center text-success card-footer bg-transparent" style="border: 1px solid #02DA5A;">Ver alumnos</a>
        </div></div>
        ...
        <a href="./Tableros_registros_linea_investigacion?clave=<%=clave%>&nombreC=<%=nombreC%>&registros=profesores" role="button" class="<%=request.getAttribute("bloProf")%> btn text-center text-danger card-footer bg-transparent" style="border: 1px solid #FE5656;">Ver profesores</a>
        </div></div>
        ...
        <a href="./Tableros_registros_linea_investigacion?clave=<%=clave%>&nombreC=<%=nombreC%>&registros=cuerpos" role="button" class="<%=request.getAttribute("bloCuerpo")%> btn text-center text-warning card-footer bg-transparent" style="border: 1px solid #FFC143;">Ver cuerpos academicos</a>
        </div></div>
