<%-- 
    Document   : Tableros_linea_cuerpos
    Created on : 18 may. 2020, 8:50:04
    Author     : laloa
--%>
...
<!--Fin de titulo horizontal-->  
	...
	<div class="content" style="z-index: 2; height: 100vh; min-width: 650px;">
        <h2 class="text-muted"><i class="fas fa-file-import"></i> Lineas de investigacion de cuerpos</h2>
        ...
        String LineaNombresCuerpo[]=(String [])request.getAttribute("LineaNombresCuerpo");
        String nombreCuerpo[]=(String [])request.getAttribute("nombreCuerpo");
        String jefeCuerpo[]=(String [])request.getAttribute("jefeCuerpo");
        String nombre_red[]=(String [])request.getAttribute("nombre_red");
        ...
        <input type="hidden" name="nombre<%=i%>" value="<%=nombreCuerpo[i]%>">
        <input type="hidden" name="jefe<%=i%>" value="<%=jefeCuerpo[i]%>">
      ...
      <tbody>
      <%for(int i=0; i<nombreCuerpo.length; i++){%>
      <tr class="<%=opcBordeCuerpo[i]%>">
      <td class="text-left"><%=LineaNombresCuerpo[i]%></td>
      <td class="text-left"><%=nombreCuerpo[i]%></td>
      <td class="text-left"><%=jefeCuerpo[i]%></td>
      ...
      <div class="form-inline justify-content-between">
        <div class="text-muted mb-2">Total de asignaciones: <input type="text" class="text-center" value="<%=conteoRegCuerpo%>" size=2 readonly></div> 
