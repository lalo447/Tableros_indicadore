<%-- 
    Document   : Graficas_tableros_cuerpo_academico
    Created on : 22 may. 2020, 14:06:07
    Author     : laloa
--%>
...
<!--Fin de titulo horizontal-->  
	...
	<div class="content" style="z-index: 2; height: 110vh; min-width: 650px;">
        <h3 class="text-muted"><i class="fas fa-archive"></i> <%=titulo%></h3>
       ...
       <option value="Linea">Linea</option>
        ...
        <div class="form-inline my-2">
          <p class="text-muted"> <%=(String)request.getAttribute("cuerpo_academico")%> asignaciones <%=(Integer)request.getAttribute("conteoReg")%>, total de asignaciones <%=(Integer)request.getAttribute("conteoTotal")%> </p>
        </div>
