<%-- 
    Document   : Tableros_profesor
    Created on : 7 may. 2020, 16:03:22
    Author     : laloa
--%>
...
<!--Fin de titulo horizontal-->  
	...
	<div class="content" style="z-index: 2; height: 100vh; min-width: 400px;">
        ...
        <p class="text-muted mx-3"><i class="fas fa-chalkboard-teacher"></i> <%=nombreC%></p>
        ...
        <a href="./Tableros_proyectos_profesor?rfc=<%=rfc%>" role="button" class="<%=request.getAttribute("bloProy")%> btn text-center text-success card-footer bg-transparent" style="border: 1px solid #02DA5A;">Ver proyectos</a>
        </div></div>
        ...
        <a href="./Tableros_publicaciones_profesor?rfc=<%=rfc%>" role="button" class="<%=request.getAttribute("bloPub")%> btn text-center text-danger card-footer bg-transparent" style="border: 1px solid #FE5656;">Ver publicaciones</a>
        </div></div>
        ...
        <a href="./Tableros_informes_profesor?rfc=<%=rfc%>" role="button" class="<%=request.getAttribute("bloInfrep")%> btn text-center text-warning card-footer bg-transparent" style="border: 1px solid #FFC143;">Ver informes</a>
        </div></div>
        ...
        <a href="./Tableros_software_profesor?rfc=<%=rfc%>" role="button" class="<%=request.getAttribute("bloSoft")%> btn text-center text-info card-footer bg-transparent" style="border: 1px solid #3FBAE8;">Ver software</a>
        </div></div>
        ...
        <a href="./Tableros_patentes_profesor?rfc=<%=rfc%>" role="button" class="<%=request.getAttribute("bloPat")%> btn text-center text-secondary card-footer bg-transparent" style="border:1px solid #A0A6B3;">Ver patentes</a>
        </div></div>
        ...
        <a href="./Tableros_derechos_autor_profesor?rfc=<%=rfc%>" role="button" class="<%=request.getAttribute("bloDcho")%> btn text-center text-dark card-footer bg-transparent" style="border: 1px solid #545454;">Ver derechos de autor</a>
        </div></div>
        </div>
