<%-- 
    Document   : Resumen_tableros_alumnos
    Created on : 13 may. 2020, 18:52:27
    Author     : laloa
--%>
...
<!--Fin de titulo horizontal-->  
	...
	<div class="content" style="z-index: 2; height: 100vh; min-width: 650px;">
        <h2 class="text-muted"><i class="fas fa-user-graduate"></i> <%=request.getAttribute("tituloPrin").toString()%></h2>
