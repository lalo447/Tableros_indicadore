<%-- 
    Document   : Tableros_cuerpos_academicos
    Created on : 19 may. 2020, 12:04:13
    Author     : laloa
--%>
...
<!--Fin de titulo horizontal-->  
	...
	<div class="content" style="z-index: 2; height: 100vh; min-width: 400px;">
        ...
        <a href="./Tableros_integrantes_cuerpos_academicos" role="button" class="<%=request.getAttribute("bloInt")%> btn text-center text-success card-footer bg-transparent" style="border: 1px solid #02DA5A;">Ver integrantes</a>
        </div></div>
