...
<!--Fin de titulo horizontal-->  
	...
	<div class="content" style="z-index: 2; height: 100vh; min-width: 400px;">
        ...
        <p class="card-text text-center">Lineas asignadas</p>
        </div>
        <a href="./Tableros_alumnos_lineas_investigacion" role="button" class="btn text-center text-info card-footer bg-transparent" style="border: 1px solid #3FBAE8;">Ver alumnos</a>
        </div></div>
        ...
        <a href="./Tableros_publicaciones_alumnos" role="button" class="btn text-center text-danger card-footer bg-transparent" style="border: 1px solid #FE5656;">Ver profesores</a>
        </div></div>
        ...
        <a href="./Tableros_informes_alumnos" role="button" class="btn text-center text-warning card-footer bg-transparent" style="border: 1px solid #FFC143;">Ver cuerpos academicos</a>
        </div></div>
