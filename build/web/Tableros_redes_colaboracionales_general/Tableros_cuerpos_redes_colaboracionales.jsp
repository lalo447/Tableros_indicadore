<%-- 
    Document   : Tableros_cuerpos_redes_colaboracionales
    Created on : 24 may. 2020, 14:55:55
    Author     : laloa
--%>
...
<!--Fin de titulo horizontal-->  
	...
	<div class="content" style="z-index: 2; height: 100vh; min-width: 650px;">
        <h2 class="text-muted"><i class="fas fa-broadcast-tower"></i> Cuerpos academicos de redes de colaboracion</h2>
       ...
       /*Realizamos los query de consultas de los cuerpos academicos*/
        ...
        rsNumRegistros=stNumRegistros.executeQuery("select r.nombre_red, count(c.clave_cuerpo) from cuerpo_academico c, red_colaboracion r where c.clave_red=r.clave_red group by r.nombre_red order by r.nombre_red");      
        stConteo=con.createStatement();
        rsConteo=stConteo.executeQuery("select count(*) from cuerpo_academico c, red_colaboracion r where c.clave_red=r.clave_red order by r.nombre_red");      
        st=con.createStatement();
        rs=st.executeQuery("select r.nombre_red, c.nombre_cuerpo, c.jefe_cuerpo, (select nombre_linea from linea_investigacion where clave_linea=c.clave_linea) from cuerpo_academico c, red_colaboracion r where c.clave_red=r.clave_red order by r.nombre_red");
        ...
        <form method="POST" action="./Graficas_de_tableros_redes_colaboracionales">
