<%-- 
    Document   : Tableros_departamentos_redes_colaboracionales
    Created on : 24 may. 2020, 14:08:53
    Author     : laloa
--%>
...
<!--Fin de titulo horizontal-->  
	...
	<div class="content" style="z-index: 2; height: 100vh; min-width: 650px;">
       ...
       /*Realizamos los query de consultas de los departamentos*/
        ...
        rsNumRegistros=stNumRegistros.executeQuery("select r.nombre_red, count(d.clave_departamento) from departamento d, red_colaboracion r where d.clave_red_fk=r.clave_red group by r.nombre_red order by r.nombre_red");      
        stConteo=con.createStatement();
        rsConteo=stConteo.executeQuery("select count(*) from departamento d, red_colaboracion r where d.clave_red_fk=r.clave_red order by r.nombre_red");      
        st=con.createStatement();
        rs=st.executeQuery("select r.nombre_red, d.nombre_departamento, d.jefe_departamento, (select nombre_institucion from institucion where clave_institucion=clave_institucion_fk) from departamento d, red_colaboracion r where d.clave_red_fk=r.clave_red order by r.nombre_red");
