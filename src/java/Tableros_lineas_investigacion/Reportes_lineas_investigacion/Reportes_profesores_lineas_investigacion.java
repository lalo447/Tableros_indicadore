...
public class Reportes_profesores_lineas_investigacion extends HttpServlet {
    ...
    Paragraph titulo_doc = new Paragraph("Registro de profesores",tnr1);
    ...
    for(int i=0; i<conteoReg2; i++){
        ...
        Paragraph t4=new Paragraph("Status",tnr2);
