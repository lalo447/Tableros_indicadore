...
public class Reportes_cuerpos_lineas_investigacion extends HttpServlet {
    ...
    nombre_red[i]=new String(request.getParameter("nombre_red"+i).getBytes("iso-8859-1"),"UTF-8");
    }
    ...
    for(int i=0; i<conteoReg2; i++){
        ...
        Paragraph t3=new Paragraph("Red",tnr2);
