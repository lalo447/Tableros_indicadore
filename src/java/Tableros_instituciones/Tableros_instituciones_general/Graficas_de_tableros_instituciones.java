...
public class Graficas_de_tableros_instituciones extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("./Tableros_instituciones_general/Graficas_de_tableros_instituciones.jsp").forward(request, response);  
