...
public class Tableros_red_colaboracion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        rs=st.executeQuery("select count(distinct clave_departamento) from departamento d, red_colaboracion r where d.clave_red_fk=r.clave_red and r.clave_red='"+clave+"'");
        while(rs.next()){
        ...
        st=con.createStatement();
        rs=st.executeQuery("select count(distinct clave_cuerpo) from cuerpo_academico c, red_colaboracion r where c.clave_red=r.clave_red and r.clave_red='"+clave+"'");
        while(rs.next()){
     ...
     request.setAttribute("bloCuerpo",bloCuerpo);  
      ...
      request.getRequestDispatcher("./Tableros_redes_colaboracion_individual/Tableros_red_colaboracion.jsp").forward(request, response);  
