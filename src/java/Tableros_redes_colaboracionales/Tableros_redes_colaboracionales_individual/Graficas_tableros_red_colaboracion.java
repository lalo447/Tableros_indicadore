...
public class Graficas_tableros_red_colaboracion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String registro=new String(request.getParameter("Departamento").getBytes("iso-8859-1"),"UTF-8");
        ...
        request.getRequestDispatcher("./Tableros_redes_colaboracion_individual/Graficas_registros_red_colaboracion.jsp").forward(request, response);  
