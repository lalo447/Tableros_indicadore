...
package Tableros_redes_colaboracionales.Reportes_redes_colaboracionales;
...
public class Reportes_departamentos_redes_colaboracionales extends HttpServlet {

    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
         int conteoReg = Integer.parseInt(request.getParameter("conteoReg"));
    String nombre[]=new String[conteoReg];
    String jefe[]=new String[conteoReg];
    String nombre_red[]=new String[conteoReg];
    ...
    jefe[i]=new String(request.getParameter("jefe"+i).getBytes("iso-8859-1"),"UTF-8");
    nombre_red[i]=new String(request.getParameter("institucion"+i).getBytes("iso-8859-1"),"UTF-8");
    }
    ...
    Paragraph titulo_doc = new Paragraph("Registro de departamentos",tnr1);
    ...
    for(int i=0; i<conteoReg2; i++){
        ...
        for(int x=0; x<conteoNum[i]; x++){
         ...
         tabla.addCell(jefe[y]); 
         tabla.addCell(nombre_red[y]);
         y++;
