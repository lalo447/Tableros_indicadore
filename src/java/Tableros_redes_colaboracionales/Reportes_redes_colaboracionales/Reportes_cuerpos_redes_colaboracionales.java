...
public class Reportes_cuerpos_redes_colaboracionales extends HttpServlet {
    ...
    String linea[]=new String[conteoReg];
    ...
    linea[i]=new String(request.getParameter("linea"+i).getBytes("iso-8859-1"),"UTF-8");
    }
    ...
    Paragraph titulo_doc = new Paragraph("Registro de cuerpos academicos",tnr1);
    ...
    for(int i=0; i<conteoReg2; i++){
        ...
        Paragraph t3=new Paragraph("Linea de investigacion",tnr2);
