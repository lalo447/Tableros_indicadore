...
public class Graficas_de_tableros_redes_colaboracionales extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("./Tableros_redes_colaboracionales_general/Graficas_tableros_redes_colaboracionales.jsp").forward(request, response);  
