...
public class Resumen_tableros_profesores extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      request.getRequestDispatcher("./Tableros_profesores_general/Resumen_tableros_profesores.jsp").forward(request, response);  
