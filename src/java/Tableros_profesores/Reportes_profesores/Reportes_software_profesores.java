...
public class Reportes_software_profesores extends HttpServlet {
    ...
    String horas[]=new String[conteoReg];
    String pais[]=new String[conteoReg];
    String fecha_terminacion[]=new String[conteoReg];
    ...
    horas[i]=request.getParameter("horas"+i);
    pais[i]=new String(request.getParameter("pais"+i).getBytes("iso-8859-1"),"UTF-8");
    fecha_terminacion[i]=new String(request.getParameter("fecha_bus_con"+i).getBytes("iso-8859-1"),"UTF-8");
    }
    ...
    Paragraph titulo_doc = new Paragraph("Registro de software",tnr1);
    ...
    for(int i=0; i<conteoReg2; i++){
        ...
        Paragraph t3=new Paragraph("Horas de desarrollo",tnr2);
        ...
        Paragraph t5=new Paragraph("Fecha de terminacion",tnr2);
        ...
        for(int x=0; x<conteoNum[i]; x++){
         ...
         tabla.addCell(horas[y]); 
         tabla.addCell(pais[y]); 
         tabla.addCell(fecha_terminacion[y]);
         y++;
