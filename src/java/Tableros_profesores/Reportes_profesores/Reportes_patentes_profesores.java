...
public class Reportes_patentes_profesores extends HttpServlet {
    ...
    String pais[]=new String[conteoReg];
    String fecha_presentacion[]=new String[conteoReg];
    String fecha_concesion[]=new String[conteoReg];
    ...
    pais[i]=new String(request.getParameter("pais"+i).getBytes("iso-8859-1"),"UTF-8");
    fecha_presentacion[i]=new String(request.getParameter("fecha_presentacion"+i).getBytes("iso-8859-1"),"UTF-8");
    fecha_concesion[i]=new String(request.getParameter("fecha_bus_con"+i).getBytes("iso-8859-1"),"UTF-8");
    }
    ...
    Paragraph titulo_doc = new Paragraph("Registro de patentes",tnr1);
    ...
    for(int i=0; i<conteoReg2; i++){
        ...
        for(int x=0; x<conteoNum[i]; x++){
         ...
         tabla.addCell(pais[y]); 
         tabla.addCell(fecha_presentacion[y]);
         tabla.addCell(fecha_concesion[y]);
         y++;
