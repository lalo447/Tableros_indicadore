...
package Tableros_profesores.Reportes_profesores;
...
public class Reportes_publicaciones_profesores extends HttpServlet {

    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        //Obtenemos todos los valores mostrados en la vista jsp con getParameter(). 
    ...
    String nombre_publicador[]=new String[conteoReg];
    String tipo[]=new String[conteoReg];
    String estado[]=new String[conteoReg];
    String num_volumen[]=new String[conteoReg];
    String año_publicacion[]=new String[conteoReg];
    
    try 
    {      
    for(int i=0; i<conteoReg; i++){
    titulo[i]=new String(request.getParameter("titulo"+i).getBytes("iso-8859-1"),"UTF-8");
    nombre_publicador[i]=new String(request.getParameter("nombre_publicador"+i).getBytes("iso-8859-1"),"UTF-8");
    ...
    num_volumen[i]=new String(request.getParameter("volumen"+i).getBytes("iso-8859-1"),"UTF-8");
    año_publicacion[i]=new String(request.getParameter("fecha_bus_con"+i).getBytes("iso-8859-1"),"UTF-8");
    }
    ...
    Paragraph titulo_doc = new Paragraph("Registro de publicaciones",tnr1);
