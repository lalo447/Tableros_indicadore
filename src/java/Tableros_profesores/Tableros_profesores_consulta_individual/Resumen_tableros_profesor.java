...
public class Resumen_tableros_profesor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
     ...
     try{
      ...
      request.getRequestDispatcher("./Tableros_profesores_individual/Resumen_tableros_profesor.jsp").forward(request, response);  
