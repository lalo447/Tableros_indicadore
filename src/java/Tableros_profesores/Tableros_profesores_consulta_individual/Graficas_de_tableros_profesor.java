...
public class Graficas_de_tableros_profesor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      /*Realizamos los query de consultas de proyectos*/
        ...
        rsNumRegistros=stNumRegistros.executeQuery("select u.nombre, u.apellido_p, u.apellido_m, count(u.rfc) from usuario_profesor u, prof_colbr_proy pr, proyecto p  where u.rfc=pr.rfc and pr.clave_proyecto=p.clave_proyecto group by u.rfc order by u.nombre");      
        stConteo=con.createStatement();
        rsConteo=stConteo.executeQuery("select count(*) from usuario_profesor u, prof_colbr_proy pr, proyecto p  where u.rfc=pr.rfc and pr.clave_proyecto=p.clave_proyecto order by u.nombre");      
        st=con.createStatement();
        rs=st.executeQuery("select p.fch_fin from usuario_profesor u, prof_colbr_proy pr, proyecto p  where u.rfc=pr.rfc and pr.clave_proyecto=p.clave_proyecto order by u.nombre");
        ...
        st=con.createStatement();
        rs=st.executeQuery("select p.ano_publicacion from usuario_profesor u, prof_colbr_pub pr, publicaciones p  where u.rfc=pr.rfc and pr.clave_publicaion=p.clave_publicaciones order by u.nombre");
       
      }else if(titulog.equals("Informes asignados")){
          
        /*Realizamos los query de consultas de informes*/
        stNumRegistros=con.createStatement();
        rsNumRegistros=stNumRegistros.executeQuery("select u.nombre, u.apellido_p, u.apellido_m, count(u.rfc) from usuario_profesor u, prof_colbr_infrep pr, informe_reporte p  where u.rfc=pr.rfc and pr.clave_infrep=p.clave_infrep group by u.rfc order by u.nombre");      
        stConteo=con.createStatement();
        rsConteo=stConteo.executeQuery("select count(*) from usuario_profesor u, prof_colbr_infrep pr, informe_reporte p  where u.rfc=pr.rfc and pr.clave_infrep=p.clave_infrep order by u.nombre");      
        st=con.createStatement();
        rs=st.executeQuery("select p.fch_publicado from usuario_profesor u, prof_colbr_infrep pr, informe_reporte p  where u.rfc=pr.rfc and pr.clave_infrep=p.clave_infrep order by u.nombre");
        
      }else if(titulog.equals("Software asignados")){
          
        /*Realizamos los query de consultas de software*/
        stNumRegistros=con.createStatement();
        rsNumRegistros=stNumRegistros.executeQuery("select u.nombre, u.apellido_p, u.apellido_m, count(u.rfc) from usuario_profesor u, prof_colbr_soft pr, patente_software p  where u.rfc=pr.rfc and pr.clave_patente_soft=p.clave_patente_soft group by u.rfc order by u.nombre");      
        stConteo=con.createStatement();
        rsConteo=stConteo.executeQuery("select count(*) from usuario_profesor u, prof_colbr_soft pr, patente_software p  where u.rfc=pr.rfc and pr.clave_patente_soft=p.clave_patente_soft order by u.nombre");      
        st=con.createStatement();
        rs=st.executeQuery("select p.fch_terminacion from usuario_profesor u, prof_colbr_soft pr, patente_software p  where u.rfc=pr.rfc and pr.clave_patente_soft=p.clave_patente_soft order by u.nombre");
      
      }else if(titulog.equals("Patentes asignadas")){
          
         /*Realizamos los query de consultas de patentes*/
        stNumRegistros=con.createStatement();
        rsNumRegistros=stNumRegistros.executeQuery("select u.nombre, u.apellido_p, u.apellido_m, count(u.rfc) from usuario_profesor u, prof_colbr_pat pr, patentes p  where u.rfc=pr.rfc and pr.clave_patente=p.clave_patente group by u.rfc order by u.nombre");      
        stConteo=con.createStatement();
        rsConteo=stConteo.executeQuery("select count(*) from usuario_profesor u, prof_colbr_pat pr, patentes p  where u.rfc=pr.rfc and pr.clave_patente=p.clave_patente order by u.nombre");      
        st=con.createStatement();
        rs=st.executeQuery("select p.fch_concesion from usuario_profesor u, prof_colbr_pat pr, patentes p  where u.rfc=pr.rfc and pr.clave_patente=p.clave_patente order by u.nombre");
      
      }else if(titulog.equals("Derechos de autor asignados")){
          
        /*Realizamos los query de consultas de derechos*/
        stNumRegistros=con.createStatement();
        rsNumRegistros=stNumRegistros.executeQuery("select u.nombre, u.apellido_p, u.apellido_m, count(u.rfc) from usuario_profesor u, prof_colbr_dcho pr, patente_dcho_autor p  where u.rfc=pr.rfc and pr.clave_dcho_autor=p.clave_dcho_autor group by u.rfc order by u.nombre");      
        stConteo=con.createStatement();
        rsConteo=stConteo.executeQuery("select count(*) from usuario_profesor u, prof_colbr_dcho pr, patente_dcho_autor p  where u.rfc=pr.rfc and pr.clave_dcho_autor=p.clave_dcho_autor order by u.nombre");      
        st=con.createStatement();
        rs=st.executeQuery("select p.fch_solicitud from usuario_profesor u, prof_colbr_dcho pr, patente_dcho_autor p  where u.rfc=pr.rfc and pr.clave_dcho_autor=p.clave_dcho_autor order by u.nombre");
      ...
      request.getRequestDispatcher("./Tableros_profesores_individual/Graficas_tableros_profesor.jsp").forward(request, response);  
