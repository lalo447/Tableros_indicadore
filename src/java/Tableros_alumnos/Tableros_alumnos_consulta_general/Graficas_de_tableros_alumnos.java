...
public class Graficas_de_tableros_alumnos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      request.getRequestDispatcher("./Tableros_alumnos_general/Graficas_tableros_alumnos.jsp").forward(request, response);  
