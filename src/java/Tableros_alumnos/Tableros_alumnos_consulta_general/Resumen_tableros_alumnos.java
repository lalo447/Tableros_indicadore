...
public class Resumen_tableros_alumnos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
     ...
     try{
      ...
      request.getRequestDispatcher("./Tableros_alumnos_general/Resumen_tableros_alumnos.jsp").forward(request, response);  
