...
public class Tableros_alumno extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
          ...
          try{
      String num_control=request.getParameter("num");
      ...
      String bloProy="", bloPub="", bloInfrep="", bloSoft="", bloPat="", bloDcho="";
        ...
        rs=st.executeQuery("select count(distinct clave_proyecto) from alm_colbr_proy where numero_control='"+num_control+"'");
        while(rs.next()){
        ...
        st=con.createStatement();
        rs=st.executeQuery("select count(distinct clave_publicacion) from alm_colbr_pub where numero_control='"+num_control+"'");
        while(rs.next()){
        ...
        st=con.createStatement();
        rs=st.executeQuery("select count(distinct clave_infrep) from alm_colbr_infrep where numero_control='"+num_control+"'");
        while(rs.next()){
        ...
        st=con.createStatement();
        rs=st.executeQuery("select count(distinct clave_patente_soft) from alm_colbr_soft where numero_control='"+num_control+"'");
        while(rs.next()){
        ...
        st=con.createStatement();
        rs=st.executeQuery("select count(distinct clave_patente) from alm_colbr_pat where numero_control='"+num_control+"'");
        while(rs.next()){
        ...
        st=con.createStatement();
        rs=st.executeQuery("select count(distinct clave_dcho_autor) from alm_colbr_dcho where numero_control='"+num_control+"'");
        while(rs.next()){
      ...
      request.setAttribute("num",num_control);
      ...
      request.getRequestDispatcher("./Tableros_alumnos_individual/Tableros_alumno.jsp").forward(request, response);  
