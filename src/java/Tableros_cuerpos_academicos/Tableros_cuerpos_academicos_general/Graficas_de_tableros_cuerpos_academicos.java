...
public class Graficas_de_tableros_cuerpos_academicos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("./Tableros_cuerpos_academicos_general/Graficas_tableros_cuerpos_academicos.jsp").forward(request, response);  
