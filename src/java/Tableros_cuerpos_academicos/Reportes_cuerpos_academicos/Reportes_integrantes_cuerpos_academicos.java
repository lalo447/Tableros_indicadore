...
package Tableros_cuerpos_academicos.Reportes_cuerpos_academicos;
...
public class Reportes_integrantes_cuerpos_academicos extends HttpServlet {
    ...
    String clave_linea[]=new String[conteoReg];
    ...
    clave_linea[i]=new String(request.getParameter("clave_linea"+i).getBytes("iso-8859-1"),"UTF-8");
    }
    ...
    Paragraph titulo_doc = new Paragraph("Registro de integrantes",tnr1);
    ...
    for(int i=0; i<conteoReg2; i++){
        ...
        Paragraph t4=new Paragraph("Linea",tnr2);
